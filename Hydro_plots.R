...
#write.csv(q_obs, "C:/Users/rooda/Dropbox/Proyectos/Puelo PEGH/Results/Q_obs_monthly.csv")
#write.csv(q_sim, "C:/Users/rooda/Dropbox/Proyectos/Puelo PEGH/Results/Q_sim_monthly.csv")
...
for(i in 1:10) {
  ...
  title1 <-list(text = names_gauge[i], font = f, showarrow = F, xref = "paper", yref = "paper", x = 0.03, y = 1)
  title11 <-list(text = "a) Caudal medio anual", font = f, showarrow = F, xref = "paper", yref = "paper", x = 0.03, y = 0.1)
  ...
  title3 <-list(text = "c) Caudal mensual", font = f, showarrow = F, xref = "paper", yref = "paper", x = 0.03, y = 0.9)
  ...
  title4 <-list(text = "d) Curva de duración", font = f, showarrow = F, xref = "paper", yref = "paper", x = 0.22, y = 0.9)

...
PP_CR2MET_m <- tapp(PP_CR2MET, strftime(time(PP_CR2MET),format="%Y-%W"), fun = sum)
...
for (i in 1980:2020){
  ...
  PET_GLEAM_i <- crop(PET_GLEAM_i, extent(c(-75,-70,-51,-40)))
  ...
  ET_GLEAM_i <- crop(ET_GLEAM_i, extent(c(-75,-70,-51,-40)))
